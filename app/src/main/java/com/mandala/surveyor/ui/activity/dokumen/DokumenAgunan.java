...
public class DokumenAgunan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_dokumen_agunan);
    ...
    private void initViewVisibleForm() {
        ...
        if (kategory.equals("Otomotive") && type.equals("Motor")) {
            tvPortfolioAgunan.setText("Portfolio Otomotif (Motor)");
            viewAgunanMobil.setVisibility(View.GONE);
        } else if (kategory.equals("Otomotive") && type.equals("Mobil")) {
            tvPortfolioAgunan.setText("Portfolio Otomotif (Mobil)");
            viewAgunanMobil.setVisibility(View.VISIBLE);
        } else if (kategory.equals("Micro")) {
            tvPortfolioAgunan.setVisibility(View.GONE);
        }
    }
